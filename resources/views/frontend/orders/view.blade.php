                    ...
                    <div class="shadow bg-white p-3">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <h6>Tracking Id/No: {{ $order->id }}</h6>
                                <h6>Order Created Date: {{ $order->created_at->format('d-m-Y h:i A') }}</h6>
                                <h6>Payment Mode {{ $order->payment_mode }}</h6>
                                <h6 class="border p-2 text-success">
                                    Order Status Massage: <span class="text-uppercase">{{ $order->status_massage }}</span>
                                </h6>
                            </div>
                            <div class="col-md-6">
                                <h5>User Details</h5>
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($order->orderItems as $orderItem)
                                            ...
                                            <td>
                                                ...
                                                @if ($orderItem->productColor)
                                                    @if ($orderItem->productColor->color)
                                                        <span>color: {{ $orderItem->productColor->color->name }}
                                                        </span>
                                                    @endif
                                                @endif
                                            </td>
                                        ...
                                        @endforeach
                                        <tr>
                                            <td colspan="5" class="fw-bold">TotalAmount:</td>
