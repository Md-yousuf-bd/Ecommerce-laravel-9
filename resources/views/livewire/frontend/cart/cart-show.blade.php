                                ...
                                <div class="cart-item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-7 my-auto">
                                            <div class="quantity">
                                                <div class="input-group">
                                                    <button class="btn btn1" wire:loading.attr="disabled" wire:click="decrementQuantity({{ $cartItem->id }})"><i class="fa fa-minus"></i></button>
                                        ...
                                        <div class="col-md-2 col-5 my-auto">
                                            <div class="remove">
                                                <button href="" wire:click="removeCartItem({{ $cartItem->id }})" class="btn btn-danger btn-sm">
